    ...
    return (
        <div className="container no-puzzles">
            ...
            <div className="content">
                <a href="https://examples.near.org?from=crossword" className="btn" target="_blank">
                    NEAR Examples
                    <br />
                    (for developers)
                </a>
            ...
            <div className="content">
                <a href="https://awesomenear.com?from=crossword" className="btn" target="_blank">
                    Awesome NEAR projects.
                    <br />
                    (DeFi, NFTs, games, comics…)
                </a>
            </div>
        </div>
    );
